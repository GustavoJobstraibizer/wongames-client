...
Cypress.Commands.add('signIn', (user?: User) => {
    cy.findByPlaceholderText(/email/i).type(user?.email || 'gustavojobs.dev@gmail.com')
    cy.findByPlaceholderText(/^password/i).type(user?.password || '123456')
